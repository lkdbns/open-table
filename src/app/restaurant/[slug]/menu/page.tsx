        ...
        <main className="bg-gray-100 min-h-screen w-screen">
            ...
            <div className="flex m-auto w-2/3 justify-between items-start 0 -mt-11">
                ...
                <nav className="flex text-reg border-b pb-2">
                    <Link href="/restaurant/milstones-grill" className="mr-7">Overview</Link>
                    <Link href="/restaurant/milstones-grill/menu" className="mr-7">Menu</Link>
                </nav>
                {/* RESTAURANT NAV*/}
                {/* MENU */}
                <main className="bg-white mgt-10">
                    <div>
                    ...
                    <div className="flex flex-wrap justify-between">
                        ...
                        <p className="font-light mt-1 text-sm">
                            A well done steak with lobster tail
                        </p>
                        <p className="mt-7">$79.99</p>
                        </div>
                        {/* MENU CARD */}
                    </div>
                    </div>
