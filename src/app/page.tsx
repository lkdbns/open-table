        ...
        <main>
          ...
          <div className="h-64 bg-gradient-to-r from-[#0f1f47] to-[#5f6984] p-2">
            <div className="text-center mt-10">
              ...
              <div className="text-left py-3 m-auto flex justify-center">
                ...
                />
                <button className="bg-red-600 px-9 py-2 text-white" onClick={() => {
          ...
          <div className="py-3 px-36 mt-10 flex flex-wrap">
            ...
            <div className="w-64 h-72 m-3 rounded overflow-hidden border cursor-pointer">
              ...
              <img src="https://resizer.otstatic.com/v2/photos/wide-huge/4/53334852.webp" alt="" className="w-full h-36" />
              <div className="p-1">
                ...
                <div className="flex text-reg font-light capitalize">
                  <p className="mr-3">American</p>
                  <p className="mr-3">$$$$</p>
                  <p className="mr-3">Texas</p>
                </div>
                <p className="test-reg font-bold mt-1">Booked 3 times today</p>
              </div>
              </Link>
            </div>
            {/*CARD*/}
